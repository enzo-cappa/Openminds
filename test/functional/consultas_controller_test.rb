...
require 'consultas_controller'

# Re-raise errors caught by the controller.
class ConsultasController; def rescue_action(e) raise e end; end

class ConsultasControllerTest < Test::Unit::TestCase
  fixtures :consultas

  def setup
    @controller = ConsultasController.new
